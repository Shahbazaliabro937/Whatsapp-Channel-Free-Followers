...
<body>
    ...
    <!-- 1. Navigation Header (Replicating typical website header) -->
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center space-x-4">
                    <!-- Nav Links -->
                    <button class="text-sm font-medium hover:text-gray-300 transition duration-150" onclick="showSubmissionView()">
                        Submission
                    </button>
                    <button id="admin-link-btn" class="hidden text-sm font-medium text-yellow-300 hover:text-yellow-400 transition duration-150" onclick="showAdminDashboard()">
                        Admin Panel
                    </button>
                </div>
            </div>
    ...
    <div id="app" class="main-container flex flex-col items-center pt-8">
        <div class="w-full max-w-4xl bg-white rounded-lg p-6 card">
            ...
            <div id="admin-dashboard-view" class="hidden">
                ...
                <button class="text-sm font-semibold text-white px-3 py-2 rounded-md bg-gray-500 hover:bg-gray-600 transition duration-150 mb-4" onclick="showSubmissionView()">
    ...
    <!-- Firebase SDK Imports (Logic is the same as the previous version) -->
    <script type="module">
                ...
                snapshot.forEach((doc) => {
                    ...
                    const appealElement = `
                        <div class="border p-4 rounded-lg shadow-md bg-white space-y-2 border-l-4 border-red-500">
                            ...
                            <p class="text-xs text-gray-400">Submitted By: <span class="text-gray-600">${data.submittedBy}</span></p>
